    ...
    <section className="px-4 py-16  md:px-24 lg:px-28 lg:py-20">
      <div className="App">
        <Pdf targetRef={ref} filename="blog.pdf">
          {({ toPdf }) => (
            <button className="btn" type="button" onClick={toPdf}>
              Download
            </button>
          )}
        </Pdf>
          ...
          <div className="grid lg:grid-cols-3 gap-6 mt-10">
            ...
            <div className="space-y-4 border-2 p-4 border-dotted rounded-lg border-indigo-500">
              ...
              <p className="text-gray-700 font-medium ">
                PropTypes is React’s internal mechanism for adding type checking to component props. React components use a special property called propTypes to set up type checking. When props are
                passed to a React component, they are checked against the type definitions configured in the propTypes property. When an invalid value is passed for a prop, a warning is displayed on
                the JavaScript console. <br /> <span className="text-red-500">Note:</span> that type checking propTypes can happen only in development mode, enabling to catch bugs in React application
            ...
            {/* Q -4 */}
            <div className="space-y-4 border-2 p-4 border-dotted rounded-lg border-indigo-500">
              <h2 className="lg:text-2xl font-bold">4. What is a custom hook, and why will you create a custom hook?</h2>
              <p className="text-gray-700 font-medium lg:text-xl">
                Custom hooks are reusable functions that a React developer can use to add special and unique functionality to the React applications.
              </p>
              <p className="text-gray-700 font-medium lg:text-xl">
                ...
                needs to be written repeatedly, we can solve this problem by using custom hook. custom hook special JavaScript function whose name starts with (use) and can be used to call other hooks.
              </p>
            </div>
          </div>
        </div>
