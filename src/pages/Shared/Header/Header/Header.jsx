      ...
      <nav className="lg:px-32 h-20 flex justify-between items-center pl-4 bg-white ">
        <div>
          <Link to="/">
            <h2 className="text-4xl font-bold">
              Pri<span className="font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-lime-600 to-slate-700">m</span>i
              <span className="font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-lime-600 to-slate-700">o</span>Chefs
            </h2>
          </Link>
        </div>
        ...
        <div>
          ...
          >
            ...
            <button type="button" className="btn block  lg:hidden ">
              login
            </button>
          </div>
        </div>
